import Data from "@data/sections/FeaturesTwoPrice.json";

const FeaturesTwoPrice = () => {
  return (
    <>
        {/* features two */}
        <section className="mil-soft-bg mil-relative">
            <img src="/img/photo/bg.svg" className="mil-bg-img" alt="image" />
            ...
            <div className="container mil-p-120-60">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6" key={`features-two-item-${key}`}>
...
export default FeaturesTwoPrice;