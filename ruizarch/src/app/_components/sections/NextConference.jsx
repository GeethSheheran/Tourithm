import Data from "@data/sections/NextConference.json";
import Link from "next/link";

const NextConference = ({ bg }) => {
    return (
        <>
            {/* call to action two */}
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-9">
                            <div className="mil-center">
                                ...
                                <h3 className="mil-light mil-thin mil-mb-60">Access to VIP Networking Conferences
                                A rare chance to network with top-tier experts, receive personalized feedback, and gain insider guidance to help scale your business faster and smarter.</h3>
